...
namespace Nala.Syntax
{
    ...
    public abstract partial class NalaSyntaxNode : SyntaxNode
    {
        internal NalaSyntaxNode(SyntaxKind kind) : base(kind)
        {
        }

        //internal NalaSyntaxNode(GreenNode green, SyntaxNode parent, int position)
        ...
        ///// </summary>
        //internal NalaSyntaxNode(GreenNode green, int position, SyntaxTree syntaxTree)
        ...
        //    get
        //    {
        //        var result = ComputeSyntaxTree(this);
        //        Debug.Assert(result != null);
        //        return result;
        //    }
        //}

        //private static SyntaxTree ComputeSyntaxTree(NalaSyntaxNode node)
        //{
        //    ArrayBuilder<NalaSyntaxNode> nodes = null;
        ...
        //            Interlocked.CompareExchange(ref node._syntaxTree, NalaSyntaxTree.CreateWithoutClone(node), null);
        //            tree = node._syntaxTree;
        //            break;
        //        }
        ...
        //        (nodes ?? (nodes = ArrayBuilder<NalaSyntaxNode>.GetInstance())).Add(node);
        //        node = parent;
        //    }
        ...
        ///// </summary>
        //internal new NalaSyntaxNode Parent
        //{
        //    get
        //    {
        //        return (NalaSyntaxNode)base.Parent;
        //    }
        //}

        //internal new NalaSyntaxNode ParentOrStructuredTriviaParent
        //{
        //    get
        //    {
        //        return (NalaSyntaxNode)base.ParentOrStructuredTriviaParent;
        //    }
        //}

        //// TODO: may be eventually not needed
        //internal NalaSyntaxNode CsGreen
        //{
        //    get { return (NalaSyntaxNode)this.Green; }
        //}
        ...
        ///// </summary>
        //public override string Language => LanguageConstants.Name;
        ...
        //    if (!stream.CanRead)
        //    {
        //        throw new InvalidOperationException(NalaResources.TheStreamCannotBeReadFrom);
        //    }
        ...
        //    SyntaxToken triviaToken = ((NalaSyntaxNode)trivia.GetStructure()).FindTokenInternal(position);
        ...
        //    // attribute values.
        //    NalaSyntaxNode curr = (NalaSyntaxNode)triviaToken.Parent;
        //    while (curr != null)
        //    {
        ...
        //{
        //    return SyntaxNodeRemover.RemoveNodes(this, nodes.Cast<NalaSyntaxNode>(), options);
        //}
        ...
        //{
        //    return Nala.SyntaxFactory.AreEquivalent(this, (NalaSyntaxNode)node, topLevel);
        //}
